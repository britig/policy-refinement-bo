...
class BipedalWalker(gym.Env, EzPickle):
    ...
    def reset(self):
        ...
        #print((self.np_random.uniform(-INITIAL_RANDOM, INITIAL_RANDOM), 0))
        self.hull.ApplyForceToCenter((self.np_random.uniform(-INITIAL_RANDOM, INITIAL_RANDOM), 0), True)
        #self.hull.ApplyForceToCenter((0, 0), True)
    ...
    def step(self, action):
        ...
        self.state += [l.fraction for l in self.lidar]
        assert len(self.state)==24
